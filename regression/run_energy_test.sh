...
do
    ...
    # do
        folder_name="results_energy_${file_length}/pca_$pca_level/$regression/"  # Specify the folder path here
        ...
        do
            ...
            do
                for fold in 2
                do
                    train_file="$input_path/energydata_test_${file_length}.csv"
                    train_label="$input_path/energydata_test_${file_length}_label.csv"
